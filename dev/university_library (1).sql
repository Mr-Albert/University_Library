...
--
ALTER TABLE `users_borrow_books`
  ADD CONSTRAINT `users_borrow_books_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`),
  ADD CONSTRAINT `users_borrow_books_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
